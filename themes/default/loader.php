...
register_asset("css/font-awesome-all.min.css");
register_asset("css/font-awesome-v4-shims.min.css");
...
register_asset("css/default.css");
...
register_asset("js/jquery.validate.min.js");
register_asset("js/jquery.steps.min.js");
...
register_asset('js/select2.min.js');
...
function get_default_design_template()
{
	return array(
		'image' => '',
		'repeat' => 'no-repeat',
		'color' => config('main-body-bg-color', '#F9F9F9'),
		'position' => '',
