    ...
    'user-other-settings' => array(
        ...
        'settings' => array(
            ...
            'whatsapp-button' => array(
                'type' => 'boolean',
                'title' => lang('sharer::activate-whatsapp-button'),
                'description' => lang('sharer::activate-whatsapp-button-desc'),
                'value' => true
            ),
            'pinterest-button' => array(
                'type' => 'boolean',
                'title' => lang('sharer::activate-pinterest-button'),
                'description' => lang('sharer::activate-pinterest-button-desc'),
                'value' => true
            ),
            'telegram-button' => array(
                'type' => 'boolean',
                'title' => lang('sharer::activate-telegram-button'),
                'description' => lang('sharer::activate-telegram-button-desc'),
                'value' => true
            ),
            'email-button' => array(
                'type' => 'boolean',
