...
<div class='mncrpt'>
    <div class="d-flex flex-column flex-md-row align-items-center card card-body bg-light border-bottom" style="border-bottom: 1px solid #e5e5e5;">
        <h5 class="my-0 mr-md-auto font-weight-normal" style="line-height:30px">
            <b>GoUrl Crypto Payment Box Example</b> (json, bootstrap4, mobile friendly, optional - free
            <b><a target="_blank" href="https://www.google.com/search?q=white+label+product">White Label Product</a></b> - Bitcoin/altcoin Payments with your own logo and all payment requests through your server, open source).
        </h5>
    ...
    <div class='mncrpt px-2 py-3 mx-auto my-4 text-center' style='max-width:1600px; white-space:normal'>
        ...
        <div class='card card-body bg-light d-inline-block'>
            ...
            <p class='lead'>See live
                <a href='#dmgnpcode'>generated php/html code</a> for your website below (<a target="_blank" href="https://github.com/cryptoapi/Payment-Gateway">open source class</a>)
            </p>
...
<?php if ($debug) { ?>
    <div style="margin-top:-60px" class="text-center"><a href='<?php echo $page."deb=no#b" ?>'>Hide Debug Log</a>
    <small>(or use dropdown <a href="#dropdown1">menu</a> above "Debug Raw Values Box")</small></div><?php } ?>
<div id='dmgnpcode' class='mncrpt px-2 py-3 mx-auto my-4 text-center' style='max-width:1450px; white-space:normal; display:none'>
    ...
    <p class='lead'>create new php file with this code (default
        <a target="_blank" href="https://github.com/cryptoapi/Payment-Gateway">location</a> ); ready to use (php, json, bootstrap4, mobile friendly, white label product / your own logo).
        <a href='https://gourl.io/bitcoin-payment-gateway-api.html#p8'>Read instruction</a></p>
...
&lt;/html&gt;</textarea>
    ...
    <ul class="list-group">
        <li class="list-group-item">
            <a target="_blank" href="https://gourl.io/lib/examples/box_only.php">1. View Payment Box Only (default settings, no menu, no footer)</a>
        </li>
        <li class="list-group-item">
            <a target="_blank" href="https://gourl.io/api-php.html">2. Payment Class Installation Instruction</a></li>
        <li class="list-group-item">
            <a target="_blank" href="https://github.com/cryptoapi/Payment-Gateway">3. PHP Bitcoin Payment Class on GitHub (free open source)</a>
        </li>
        <li class="list-group-item">
            <a target="_blank" href="https://gourl.io/bitcoin-payment-gateway-api.html#p8">4. JSON Payment Box Instruction</a>
        </li>
    </ul>
</div>
<footer class="container pt-4 my-md-5 pt-md-5" style="border-top: 1px solid #e5e5e5;">
    <div class="row">
        <div class="col-12 col-md">
            ...
            <br>
            <div>
                <a target="_blank" href="https://validator.w3.org/nu/?showsource=yes&amp;doc=<?php echo "https://".$_SERVER[HTTP_HOST].urlencode($_SERVER[REQUEST_URI]); ?>"><img title="Markup Validation Service" src="https://gourl.io/images/w3c.png" alt="Valid HTML 5"></a>
            </div>
        </div>
