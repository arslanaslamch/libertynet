    ...
    <?php else: ?>
        <form name='form1' style='font-size:14px;color:#444' action="pay-per-post.php#i" method="post">
            <table cellspacing='20'>
                <tr>
                    <td colspan='2'>
                        <img alt='New Post' border='0' src='https://gourl.io/images/example7.png'><?php echo $error; ?>
                    </td>
                </tr>
                <tr>
                    <td width='100'>Title:</td>
                    <td width='300'>
                        <input style='padding:6px;font-size:18px;' size='40' type="text" name="ftitle" value="<?php echo $ftitle; ?>">
                    </td>
                </tr>
                <tr>
                    <td>Text:</td>
                    <td>
                        <textarea style='padding:6px;font-size:18px;' rows="4" cols="40" name="ftext"><?php echo $ftext; ?></textarea>
                    </td>
                </tr>
                <?php if (!$box->is_paid()): ?>
                    <tr>
                        <td colspan='2'>* You need to pay <?php echo $coinName; ?>s (~<?php echo $amountUSD; ?> US$) for posting your text on our website</td>
                    </tr>
                <?php endif; ?>
            </table>
        </form>
