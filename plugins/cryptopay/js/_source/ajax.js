            ...
            .done(function (data) {
                ...
                if (data.status == "payment_received") {
                    ...
                    if (!paid || (paid && !confirmed && data.confirmed)) $.post(phpdir_path + "cryptobox.callback.php", data)
                        ...
                        .done(function (txt) {
                            if (txt != "cryptobox_newrecord" && txt != "cryptobox_updated" && txt != "cryptobox_nochanges") alert("Internal Error! " + txt);
                        });
